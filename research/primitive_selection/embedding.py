...
def derive_bkz(instance: MLWEInstance | MSISInstance) -> BKZInstance:
    ...
    draft = BKZInstance(instance.profile, instance.seed, instance.track, instance.instance_id, basis)
    result = BKZInstance(instance.profile, instance.seed, instance.track, instance.instance_id,
